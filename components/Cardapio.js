...
const Cardapio = ({ menuItems, adicionarAoCarrinho, carrinhoItens, fazerPedido }) => {
    ...
    if (!fontsLoaded) {return (
                ...
                const renderMenuItem = ({ item }) => (
                    <Pressable style={styles.itemMenu} onPress={() => adicionarAoCarrinho(item)}>
                        ...
                        <View style={styles.infoItem}>
                            ...
                            <Textstyle={styles.descricao}>{item.descricao}</Text>
                            <Textstyle={styles.preco}>R$ {item.preco.toFixed(2)}</Text>
                            <Pressable
                                style={({ pressed }) => [
                        styles.addButton,
        ...
        >
            ...
            />  <View style={styles.carrinho}>
                <Textstyle={styles.totalText}>Total do Carrinho: R$ {totalCarrinho.toFixed(2)}</Text>
                <Pressable style={styles.button} onPress={fazerPedido}>
